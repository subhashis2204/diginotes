...
function UploadPage({ setAllDocuments }) {
  ...
  return (
    <>
      <Heading className="text-center px-2 pb-8 pt-8">
      ...
      >
        <label htmlFor="title">Enter a name for your upload</label>
        <input
          type="text"
          id="title"
          value={title}
          onChange={(e) => setTitle(e.target.value)}
          className="bg-gray-50 p-2 rounded-md border border-2 border-gray-400"
        />
        <input
          id="upload"
          type="file"
